...
from utils import TEST_PROJECT_ROOT, TEST_RESOURCE_ROOT, TEST_FILE_SYSTEM_ROOT, RESOURCE_ROOT, delete_directory, \
    run_command, check_files_exist
...
class WheelTest(TestCase):
    ...
    def test_wheel_when_no_output_dir_specified(self):
        # Given
        command = [f'{RESOURCE_ROOT}/wheel', TEST_PROJECT_ROOT]
    ...
    def test_wheel_when_absolute_output_dir_specified(self):
        # Given
        command = [f'{RESOURCE_ROOT}/wheel', TEST_PROJECT_ROOT, '-o', f'{TEST_FILE_SYSTEM_ROOT}/etc/dist']
    ...
    def test_propagates_return_code_of_command(self):
        # Given
        command = [f'{RESOURCE_ROOT}/wheel', TEST_PROJECT_ROOT, '-p', '/invalid/path']
