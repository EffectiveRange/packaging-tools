...
from utils import TEST_PROJECT_ROOT, TEST_RESOURCE_ROOT, TEST_FILE_SYSTEM_ROOT, \
    delete_directory, check_file_is_in_deb, RESOURCE_ROOT, run_command, check_files_matches_in_deb, check_files_exist
...
class DhVirtualenvTest(TestCase):
    ...
    def test_dh_virtualenv_when_no_output_dir_specified(self):
        # Given
        command = [f'{RESOURCE_ROOT}/dh-virtualenv', TEST_PROJECT_ROOT]
    ...
    def test_dh_virtualenv_when_absolute_output_dir_specified(self):
        # Given
        command = [f'{RESOURCE_ROOT}/dh-virtualenv', TEST_PROJECT_ROOT, '-o', f'{TEST_FILE_SYSTEM_ROOT}/etc/dist']
    ...
    def test_dh_virtualenv_when_extra_files_specified(self):
        # Given
        command = [f'{RESOURCE_ROOT}/dh-virtualenv', TEST_PROJECT_ROOT, '-e', f'{TEST_PROJECT_ROOT}/scripts/*']
    ...
    def test_propagates_return_code_of_command(self):
        # Given
        command = [f'{RESOURCE_ROOT}/dh-virtualenv', TEST_PROJECT_ROOT, '-p', '/invalid/path']
